...
* Columns are labeled:
1. Subject number in 'train_subj' labeled as 'Subject'
2. Activity in 'train_y' labeled as 'Activity'
3. 561 features in 'train_X' labeled with the feature labels from meta data
...
* activity:
	...
	* Factor variable, 6 factors: "WALKING","WALKING_UPSTAIRS","WALKING_DOWNSTAIRS","SITTING","STANDING","LAYING"
